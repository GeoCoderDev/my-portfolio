...
const Header = () => {
  ...
  return (
    <header
      id="Header"
      className={` z-[100] flex justify-center bg-[#ffffff80] w-full fixed top-0 left-0 border-solid border-b-[1px] border-black/[.20] backdrop-blur-[10px] select-none transition-all`}
    >
      <div
        style={{ transitionDuration: "250ms" }}
        className={`py-[3vh] min-w-min max-w-screen-xl px-[2vw] grid select-none justify-center  content-center grid-cols-header-cols-2 md:grid-cols-header-cols-3 max-md:px-[2.5vw] transition-all`}
      >
        <a
